...
for (i in 1:100) {
  ...
  print(ggplot(sub) + geom_point(aes(x=frame, y=volume, color=mutant), alpha=.2) + stat_smooth(aes(x=frame, y=volume, color=mutant), method="loess") + xlim(c(0,2000)) + ylim(c(600,1050)))
