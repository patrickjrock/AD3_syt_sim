...
This plot shows the motion of principle component 1 on the aligned structures of C2A wild type and C2A Y180N.
![](images/wt_vs_Y180N.gif)


```{r echo=FALSE, message=FALSE, warning=FALSE}
source("./plots/pca_path.R")
pca_path("data/pca.data")
```
...
source("./plots/distance_line.R")
distance_density('data/dist.data')
distance_line("data/dist.data")
```

### Mutant pair distance analysis
```{r echo=FALSE, message=FALSE, warning=FALSE}
distance_density('data/mutadist.data')
distance_line("data/mutadist.data")
```

### Average distance analysis
We measured the average distances between residues in each loop.
```{r echo=FALSE, message=FALSE, warning=FALSE}
distance_density('data/avgdist.data')
distance_line("data/avgdist.data")
```
...
source("./plots/volume_line.R")
#volume_density('data/vol.data')
#volume_line('data/vol.data')
```

### Calcium binding atom volume

```{r echo=FALSE, message=FALSE, warning=FALSE}
source("./plots/calvol_density.R")
calvol_density('data/calciumvol.data')
volume_line('data/calciumvol.data')
```
...
### Chi2
```{r echo=FALSE, message=FALSE, warning=FALSE}
source("./plots/chi_hist.R")
chi_hist('data/chi.data')
source("./plots/chi_point.R")
chi_point('data/chi.data')
```


### RMSF vs RSA
```{r echo=FALSE, message=FALSE, warning=FALSE}
#source("./plots/rmsfvsrsa.R")
```

## Animation
```{r echo=FALSE, message=FALSE, warning=FALSE}
if(FALSE){
source("./plots/animation/volume_density_animation.R")
source("./plots/animation/distance_density_animation.R")
source("./plots/animation/volume_fit_animation.R")
source("./plots/animation/distance_fit_animation.R")
volume_density_animation('data/vol.data')
distance_density_animation('data/dist.data')
volume_fit_animation('data/vol.data')
distance_fit_animation('data/dist.data')
}
```
